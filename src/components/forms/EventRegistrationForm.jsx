      ...
      <div className="wrapper wrapper--w780">
        <div className="card card-3">
          ...
          <div className="card-body">
            <h2 className="title"><EventRegistrationTypeWriter/></h2>
            ...
            {formErrors["regno"] ? (
              ...
              <div className="input-group">
                <div className="rs-select2 js-select-simple select--no-search">
                  <motion.select name="year" className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                whileHover={{ scale: 1.2 }}
                                whileTap={{ scale: 0.8 }}
